...
struct GothicMemoryLocations
{
	...
	struct zCPolyStrip
	{
		static const unsigned int Offset_Material = 0x34; //this one is wrong, need to boot up union, hook on to some zCPolyStrip function and check mem location of this
